 ...
 * 
 * @see io.runebox.asm.reflect.MethodInfo
 * @see Label
 * @see Instruction
 * 
...
public class MethodEditor implements Opcode {
	 ...
	 * 
	 * @param modifiers
	 *            The {@link io.runebox.asm.reflect.Modifiers modifiers}
	 *            for the new method
	 * @param returnType
	 ...
	 * 
	 * @see ClassEditor
	 * @see io.runebox.asm.reflect.MethodInfo MethodInfo
	 */
