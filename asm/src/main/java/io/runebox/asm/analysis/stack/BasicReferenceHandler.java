package io.runebox.asm.analysis.stack;

import io.runebox.asm.utils.Descriptor;
import io.runebox.asm.utils.reflection.Casts;
  ...
  public Object getMethodReturnOrNull(BasicValue v, String owner, String name, String desc,
    ...
    if (PERMITTED_SIMULATION.contains(owner)) {
      ...
      try {
        ...
        System.err.println("Couldn't bridge reference to runtime method.");
      }
    }
    return null;
  }
