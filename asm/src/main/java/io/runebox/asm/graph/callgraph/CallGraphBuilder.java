...
package io.runebox.asm.graph.callgraph;

import io.runebox.asm.graph.inheritancegraph.InheritanceGraph;
import io.runebox.asm.graph.inheritancegraph.InheritanceGraphNode;
import io.runebox.asm.utils.TransformerHelper;
import io.runebox.asm.graph.GraphHelper;
...
public class CallGraphBuilder {
    ...
    public final CallGraph build() {
        Map<String, ClassNode> classMap = GraphHelper.validateUniqueClasses(nodes);
