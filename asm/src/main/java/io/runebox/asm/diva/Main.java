 ...
 * does.
 * 
 * @see io.runebox.asm.optimize.Main
 */
public class Main {
	...
	private static void usage() {
		System.err
				.println("Usage: java io.runebox.asm.optimize.Main"
						+ "\n            [-options] classes dir"
						+ "\n"
	...
	private static void editClass(final String className) {
		...
		if (Main.ANNO) {
			String s = "Optimized with: io.runebox.asm.diva.Main";
