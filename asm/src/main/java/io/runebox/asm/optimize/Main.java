...
package io.runebox.asm.optimize;

import java.io.*;
import java.text.*;
import java.util.*;

import io.runebox.asm.cfg.*;
import io.runebox.asm.codegen.*;
import io.runebox.asm.context.*;
import io.runebox.asm.diva.*;
import io.runebox.asm.editor.*;
import io.runebox.asm.file.*;
import io.runebox.asm.inline.*;
import io.runebox.asm.reflect.*;
import io.runebox.asm.ssa.*;
import io.runebox.asm.tbaa.*;
import io.runebox.asm.trans.*;
import io.runebox.asm.tree.*;

/**
 * Usage: java io.runebox.asm.optimize.Main [-options] classes dir
 * 
...
public class Main {
	...
	private static void usage() {
		System.err
				.println("\nUsage: java io.runebox.asm.optimize.Main"
						+ "\n            [-options] classes dir"
						+ "\n"
	...
	private static void editClass(final String className) {
		...
		if (Main.ANNO) {
			String s = "Optimized with: io.runebox.asm.optimize.Main";
